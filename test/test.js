...
describe("NFTMarketplace", function () {
  ...
  describe("Deployment", function () {
    ...
    it("Should track name and symbol of the nft collection", async function () {
      ...
      const nftName = "Dapp Studio"
      const nftSymbol = "DSTD"
  ...
  describe("Making marketplace items", function () {
    ...
    it("Should track newly created item, transfer NFT from seller to marketplace and emit Listed event", async function () {
      // addr1 offers their nft at a price of 1 ether
      await expect(marketplace.connect(addr1).listItem(nft.address, 1 , toWei(price)))
